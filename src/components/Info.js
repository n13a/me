...
import Image from '../IMG_1744.jpg'

export default function Info() {
    return (
        <div className='info-sec'>
            <img alt="me" src={Image} />
            <h1> Nima Esmaeilzadeh </h1>
            <h3> Full Stack Developer </h3>
            <a className="website" href="nimaweb.netlify.app">nimaweb.netlify.app </a>

            <div className="links">
                <a href="mailto: https://nima97e.gmail.com/" className="link email">
                ...
                <a href="https://www.linkedin.com/in/nima-esmaeilzadeh/" className="link linkedIn">
